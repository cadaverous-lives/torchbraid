...
srun -N 1 -n 1 --cpu-bind=verbose --mpibind=off python3 test_spatial_coarsening.py ${args} --lp-levels 1
 
echo control:
echo python3 test_spatial_coarsening.py ${args}
srun -N 4 -n 64 --cpu-bind=verbose --mpibind=off python3 test_spatial_coarsening.py ${args}
 
echo coarsening:
echo python3 test_spatial_coarsening.py ${args} --lp-sc-levels 2
srun -N 4 -n 64 --cpu-bind=verbose --mpibind=off python3 test_spatial_coarsening.py ${args} --lp-sc-levels 2

echo coarsening:
echo python3 test_spatial_coarsening.py ${args} --lp-sc-levels 1
srun -N 4 -n 64 --cpu-bind=verbose --mpibind=off python3 test_spatial_coarsening.py ${args} --lp-sc-levels 1

echo coarsening:
echo python3 test_spatial_coarsening.py ${args} --lp-sc-levels 1 2
srun -N 4 -n 64 --cpu-bind=verbose --mpibind=off python3 test_spatial_coarsening.py ${args} --lp-sc-levels 1 2
